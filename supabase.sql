...
create policy "public read player_card_entries"
on public.player_card_entries
for select
using (true);
...
grant select on public.games, public.players, public.events, public.player_card_entries, public.player_awards to anon, authenticated;
